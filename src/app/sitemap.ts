...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/vendor-registration`,              lastModified: now, changeFrequency: "yearly",  priority: 0.4 },
    { url: `${BASE}/po-terms`,                         lastModified: now, changeFrequency: "yearly",  priority: 0.3 },
